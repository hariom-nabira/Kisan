      ...
      <section className="bg-green-100 py-20">
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-8 items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <button className="bg-green-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-green-500 transition duration-300 transform hover:scale-105"
              onClick={handleBtn}
            >Get Started</button>
          </div>
